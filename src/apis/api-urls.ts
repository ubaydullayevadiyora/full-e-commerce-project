export class ApiUrls {
  ...
  // public static GET_ONE_CATEGORY_BY_ID = (id: string) =>
  //   `${this.GET_ONE_CATEGORY}/${id}`;
  public static CATEGORY_EDIT: string = `${this.CATEGORY}/edit`;
  // public static CATEGORY_EDIT_BY_ID = (id: string) =>
  //   `${this.CATEGORY_EDIT}/${id}`;
  public static CATEGORY_DELETE: string = `${this.CATEGORY}/delete`;
  // public static CATEGORY_DELETE_BY_ID = (id: string) =>
  //   `${this.CATEGORY_DELETE}/${id}`;
  ...
  // api not found for delete brend
  ...
  public static WISHLIST_GET_ONE = `${this.WISHLIST}/getOne`;
  ...
  // The API is not for deleting wishlists.

  //Cart api's
  public static CART: string = "/cart";
  public static CREATE_CART: string = `${this.CART}/createCart`;
  public static CART_GET_ONE = `${this.CART}/getOneCart`;
  ...
  // api for getAllContact is invalid...
  // public static GET_ONE_CONTACT_BY_ID = (id: string) =>
  //   `${this.GET_ONE_CONTACT}/${id}`;
  public static CONTACT_EDIT: string = `${this.CONTACT}/edit`;
  // public static CONTACT_EDIT_BY_ID = (id: string) =>
  //   `${this.CONTACT_EDIT}/${id}`;
  public static CONTACT_DELETE: string = `${this.CONTACT}/delete`;
  // public static CONTACT_DELETE_BY_ID = (id: string) =>
  //   `${this.CONTACT_DELETE}/${id}`;
}
